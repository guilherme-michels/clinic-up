...
export const AnamnesisTemplateScalarFieldEnumSchema = z.enum([
	"id",
	"title",
	"description",
	"createdAt",
...
export const AnamnesisQuestionScalarFieldEnumSchema = z.enum([
	"id",
	"question",
	"type",
	"isRequired",
...
export const PatientAnamnesisScalarFieldEnumSchema = z.enum([
	"id",
	"createdAt",
	"updatedAt",
	"patientId",
...
export const AnamnesisAnswerScalarFieldEnumSchema = z.enum([
	"id",
	"answer",
	"questionId",
	"patientAnamnesisId",
...
export const CustomerSatisfactionScalarFieldEnumSchema = z.enum([
	"id",
	"rating",
	"comment",
	"createdAt",
...
export const TreatmentScalarFieldEnumSchema = z.enum([
	"id",
	"description",
	"startDate",
	"endDate",
